...
export function EvvaMark() {
  ...
  return (
    <svg className="ff-evva-mark" viewBox="0 0 21000 29700" role="img" aria-label="EVVA" focusable="false" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d={EVVA_PATH} fill={`url(#${gradientId})`} />
    </svg>
  );
}
