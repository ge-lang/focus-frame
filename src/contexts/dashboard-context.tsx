...
const initialState: DashboardState = {
  widgets: [
    ...
    { id: 'news-1', type: 'news', colSpan: 8, rowSpan: 2 },
    { id: 'pomodoro-1', type: 'pomodoro', colSpan: 2, rowSpan: 2 },
    { id: 'calendar-1', type: 'calendar', colSpan: 2, rowSpan: 2 },
    { id: 'notes-1', type: 'notes', colSpan: 2, rowSpan: 2 },
    { id: 'analytics-1', type: 'analytics', colSpan: 2, rowSpan: 2 },
    { id: 'bookmarks-1', type: 'bookmarks', colSpan: 2, rowSpan: 2 },
    { id: 'goals-1', type: 'goals', colSpan: 4, rowSpan: 2 },
  ],
  layout: [
    { i: 'news-1', x: 0, y: 0, w: 8, h: 2, type: 'news' },
    { i: 'goals-1', x: 8, y: 0, w: 4, h: 2, type: 'goals' },
    { i: 'todo-1', x: 0, y: 2, w: 4, h: 2, type: 'todo' },
    { i: 'pomodoro-1', x: 4, y: 2, w: 2, h: 2, type: 'pomodoro' },
    { i: 'calendar-1', x: 6, y: 2, w: 2, h: 2, type: 'calendar' },
    { i: 'weather-1', x: 8, y: 2, w: 2, h: 2, type: 'weather' },
    { i: 'analytics-1', x: 10, y: 2, w: 2, h: 2, type: 'analytics' },
    { i: 'notes-1', x: 0, y: 4, w: 2, h: 2, type: 'notes' },
    { i: 'bookmarks-1', x: 2, y: 4, w: 2, h: 2, type: 'bookmarks' },
  ],
