...
const initialState: DashboardState = {
  ...
  layout: [
    ...
    { i: 'pomodoro-1', x: 4, y: 0, w: 2, h: 2, type: 'pomodoro' },
    { i: 'calendar-1', x: 6, y: 0, w: 2, h: 2, type: 'calendar' },
    { i: 'news-1', x: 8, y: 0, w: 4, h: 2, type: 'news' },
    { i: 'weather-1', x: 0, y: 2, w: 2, h: 2, type: 'weather' },
    { i: 'analytics-1', x: 2, y: 2, w: 2, h: 2, type: 'analytics' },
    { i: 'goals-1', x: 4, y: 2, w: 4, h: 2, type: 'goals' },
    { i: 'notes-1', x: 8, y: 2, w: 2, h: 2, type: 'notes' },
    { i: 'bookmarks-1', x: 10, y: 2, w: 2, h: 2, type: 'bookmarks' },
  ],
