...
const initialState: DashboardState = {
  widgets: [
    ...
    { id: 'news-1', type: 'news', colSpan: 12, rowSpan: 1 },
  ...
  layout: [
    { i: 'news-1', x: 0, y: 0, w: 12, h: 1, type: 'news' },
    { i: 'todo-1', x: 0, y: 1, w: 4, h: 2, type: 'todo' },
    { i: 'goals-1', x: 4, y: 1, w: 4, h: 2, type: 'goals' },
    { i: 'pomodoro-1', x: 8, y: 1, w: 2, h: 2, type: 'pomodoro' },
    { i: 'calendar-1', x: 10, y: 1, w: 2, h: 2, type: 'calendar' },
    { i: 'weather-1', x: 0, y: 3, w: 2, h: 2, type: 'weather' },
    { i: 'analytics-1', x: 2, y: 3, w: 2, h: 2, type: 'analytics' },
